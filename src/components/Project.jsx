...
const Project = ({title, description, picture, html_link}) => (
    <div className="bg-gray-300 w-full p-2 mb-10 rounded-2xl group border-gray-700 border-4 md:w-2/3 md:border-2 hover:border-gray-500">
        <Link to={html_link} className="flex flex-col md:flex-row">
            ...
            <div className="w-full h-32 justify-items-end md:justify-items-start md:h-auto md:w-1/4 mt-4 md:mt-0">
